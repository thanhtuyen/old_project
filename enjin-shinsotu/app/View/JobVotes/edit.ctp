...
<div class="wrapper wrapper-content row animated fadeInRight clearfix">
    ...
    <div class='full-content'>
        <div class='col-lg-8'>
            <div class='ibox'>
                ...
                <!-- form add -->
                <div class="ibox-content bg-white p-sm pd-bottom-none pd-right-none" id="jobVoteEdit">
                    ...
                    <div class="form-group"><label class="col-sm-4 control-label">待遇</label>
                        <div class="col-sm-8">
                            <?php echo $this->Form->textarea('treatment',array('class'=>'form-control','label' =>false,'placeholder'=>'募集要項入力')); ?>
                        </div>
                    </div>

                    <div class="form-group"><label class="col-sm-4 control-label">応募資格</label>
                        <div class="col-sm-8">
                            <?php echo $this->Form->textarea('qualification_require',array('class'=>'form-control','label' =>false,'placeholder'=>'募集要項入力')); ?>
                        </div>
                    </div>
                    <div class="form-group"><label class="col-sm-4 control-label">募集人数</label>
                        <div class="col-sm-8">
                            <div class="" id="data_3">
                                <?php echo $this->Form->input('wanted_person',array('class'=>'form-control text-right w-95','label' =>false)); ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group"><label class="col-sm-4 control-label">応募期限</label>
                        <div class="padding-lf30 col-sm-8">
                            ...
                            <div class="input-group clockpicker f_right_calendar" data-autoclose="true">
                                ...
                                <?php echo $this->Form->input('wanted_deadline_time',array('type' => 'text','class'=>'form-control','label' =>false,'div'=>false)); ?>
                            </div>
                            <div class="clear"></div>
                            <!--clock-->
                        </div>
                    ...
                    <div class="form-group"><label class="col-sm-4 control-label">公開開始日時</label>
                        <div class="padding-lf30 col-sm-8">
                            ...
                            <div class="input-group clockpicker f_right_calendar" data-autoclose="true">
                                ...
                                <?php echo $this->Form->input('start_date_time',array('type' => 'text','class'=>'form-control','label' =>false,'div'=>false)); ?>
                            </div>
                            <div class="clear"></div>
                        </div>
                        ...
                        <div class="form-group"><label class="col-sm-4 control-label ">募集年度</label>
                            <div class="col-sm-8">
                                <label class="form-control border-none font-weight-normal"><?php echo $this->request->data['JobVote']['wanted_year']; ?> 年</label>
                                <?php echo $this->Form->input('wanted_year',array('type'=>'hidden','class' => 'form-control','label' =>false,'default'=>$this->request->data['JobVote']['wanted_year'])); ?>
                            </div>
                        </div>
                        ...
                        <div class="btn-clear">
                            ...
                            <?php echo $this->Form->submit('更新',array('class'=>'btn btn-primary w-95 h-34','div'=>false)); ?>
    ...
    <div class="jobVotes form">
        ...
        <fieldset>
            <legend><?php echo __('Edit Job Vote'); ?></legend>
            <?php

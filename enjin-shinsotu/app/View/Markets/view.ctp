...
<h2><?php echo __('Market'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($market['Market']['status']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($market['Market']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($market['Market']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="related">
	...
	<?php if (!empty($market['RecCompany'])): ?>
	...
	<?php foreach ($market['RecCompany'] as $recCompany): ?>
		<tr>

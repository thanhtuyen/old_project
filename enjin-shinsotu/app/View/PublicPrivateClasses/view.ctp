<div class="publicPrivateClasses view">
<h2><?php echo __('Public Private Class'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($publicPrivateClass['PublicPrivateClass']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($publicPrivateClass['PublicPrivateClass']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Status'); ?></dt>
		<dd>
			<?php echo h($publicPrivateClass['PublicPrivateClass']['status']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($publicPrivateClass['PublicPrivateClass']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($publicPrivateClass['PublicPrivateClass']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="related">
	...
	<?php if (!empty($publicPrivateClass['SchoolInitialData'])): ?>
	...
	<?php foreach ($publicPrivateClass['SchoolInitialData'] as $schoolInitialData): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($publicPrivateClass['School'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
	...
	<?php foreach ($publicPrivateClass['School'] as $school): ?>
		<tr>

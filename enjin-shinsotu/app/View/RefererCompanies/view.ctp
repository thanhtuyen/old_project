...
<?php echo $this->Html->script('plugins/peity/jquery.peity.min.js'); ?>
  <!-- end script -->
<?php echo $this->element( 'back_nav',  array('text' => __('流入元担当者詳細｜%d %s', $infStaff['InfStaff']['id'], $infStaff['InfStaff']['name']), 'noBtn' => true) );?>
        ...
        <div class="col-lg-10">
          <form method="get" class="form-horizontal form-info">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <div class="form-control border-none h-auto">
                  <a class='text-navy' href="mailto:<?php echo $infStaff['InfStaff']['mail_address']?>"><?php echo $infStaff['InfStaff']['mail_address']?></a>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <div class="form-control border-none"> <?php echo $inf_status[$infStaff['InfStaff']['status']]; ?></div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <div class="form-control border-none">
                  <a class='text-navy' href="../../RecRecruiter/view/<?php echo $infStaff['InfStaff']['rec_recruiter_id'];?>"><?php echo $infStaff['RecRecruiter']['last_name']; ?>  <?php echo $infStaff['RecRecruiter']['first_name']; ?></a>
                </div>
              </div>
            </div>      
            <div class="form-group">

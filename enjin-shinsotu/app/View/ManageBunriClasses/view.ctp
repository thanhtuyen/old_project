<div class="manageBunriClasses view">
<h2><?php echo __('Manage Bunri Class'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($manageBunriClass['ManageBunriClass']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($manageBunriClass['ManageBunriClass']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Status'); ?></dt>
		<dd>
			<?php echo h($manageBunriClass['ManageBunriClass']['status']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($manageBunriClass['ManageBunriClass']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($manageBunriClass['ManageBunriClass']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="related">
	...
	<?php if (!empty($manageBunriClass['CanEducation'])): ?>
	...
	<?php foreach ($manageBunriClass['CanEducation'] as $canEducation): ?>
		<tr>

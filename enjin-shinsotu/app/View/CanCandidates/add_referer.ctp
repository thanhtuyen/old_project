...
<?php echo $this->Form->create('CanCandidate'); ?>
	<fieldset>
		<legend><?php echo __('Add Can Candidate'); ?></legend>
	<?php
		...
		echo $this->Form->input('home_country_id',array('options' => $countries,'empty' => ''));
		echo $this->Form->input('home_post_code');
		echo $this->Form->input('home_prefecture_id',array('options' => $prefectures,'empty' => ''));

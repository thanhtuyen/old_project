<div class="levels index">
	...
	<tr>
		...
		<td><?php echo h($level['Level']['status']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $level['Level']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $level['Level']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>

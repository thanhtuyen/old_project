<!-- title -->
<?php echo $this->element('back_nav', array('text' => __('イベント参加者 CSV 登録')))?>
<!-- end title -->
    ...
    <div class='full-content'>
        <div class='col-lg-12'>
            <div class='ibox'>
                ...
                <div class='ibox-content bg-white p-sm' id="csvAdd">
                    <?php echo $this->Form->create('EvHistories',array('action'=>'csv_add','type'=>'file', 'class'=>"form-horizontal form-edit")); ?>
                    <div class="form-group"><label class="col-sm-2 control-label">登録イベント</label>
                        <div class="col-sm-4">
                            <?php echo $this->Form->input('eventSchedule', array('class' => 'form-control', 'label' => false, 'options' => $eventSchedules )); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">入社可能年月</label>
                        <div class="col-sm-4">
                            <div class="form-group data_4 mg-left-none">
                    ...
                    <div class='wrapper-content-large-border wrapper-content-theight bg-white'>
                        <div class='wraper-process-bar'>
                            ...
                            <div class='proress-bar title-upload-progress'>
                                <label class='control-label fix-title-upload'>登録成功<?php echo $successCount; ?>件／登録エラー<?php echo count($errors); ?>件</label>
                            </div>

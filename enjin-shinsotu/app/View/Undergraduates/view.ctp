<div class="undergraduates view">
<h2><?php echo __('Undergraduate'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($undergraduate['Undergraduate']['id']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($undergraduate['Undergraduate']['name']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($undergraduate['Undergraduate']['status']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($undergraduate['Undergraduate']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($undergraduate['Undergraduate']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="related">
	...
	<?php if (!empty($undergraduate['CanEducation'])): ?>
	...
	<?php foreach ($undergraduate['CanEducation'] as $canEducation): ?>
		<tr>

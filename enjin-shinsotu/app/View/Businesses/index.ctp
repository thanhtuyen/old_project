<div class="businesses index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $business['Business']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $business['Business']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>

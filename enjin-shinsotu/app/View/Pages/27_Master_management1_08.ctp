                    ...
                    <div class="ibox">
                        <div class="ibox-title">
                          ...
                          <div class="ibox-tools">
                            <a href="27_master_management2_08" type="button" class="btn btn-primary btn-xs">編集</a>
                          </div>
                        </div>
                          ...
                          <table class="table table-bordered no-margin-bottom table-center">
                            ...
                            <tbody class="text-left">
                              ...
                              <tr>
                                ...
                                <td class="table-button-tdleft ">AREA001</td>
                                <td class="table-button-tdleft text_left">東京</td>
                              </tr>      
                              <tr>
                                <td class="table-button-tdleft">AREA002</td>
                                <td class="table-button-tdleft text_left">名古屋</td>
                              </tr>
                            </tbody>
                          </table>
                        </div>

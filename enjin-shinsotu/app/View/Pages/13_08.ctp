      ...
      <div class="sidebar-collapse">
        ...
        <div id="page-wrapper" class="gray-bg">
          <div class="row border-bottom">
            ...
            <!-- content -->
            <div class="wrapper wrapper-content animated fadeInRight title-button">
              <div class='clear'></div>
              <div class='wrapper-content-large-border bg-white'>
                ...
                <div class='wraper-process-bar'>
                  ...
                  <div class='border-bar google-map'>
                    <div class='progress-textarea'>
                      <input class='form-control bg-white border-none' value='福元庄一,フクモトショウイチ,FukumotoShouichi,男,469215183,367-0113,埼玉県,児玉郡美里町,甘粕,4-16,,1959/12/26' readonly="true">

                      <input class='form-control bg-white border-none' value='渡邊智恵,ワタナベチエ,WatanabeChie,女,390234732,105-0011,東京都,港区,芝公園,2-1,ガーデン芝公園109,1981/05/26' readonly="true">

                                                        ...
                                                        <div class="ibox-content bg-white p-sm pd-bottom-none pd-right-none">
                                                            <form method="get" class="form-horizontal">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-8 text">
                                                                        <img src="/enjin_main/enjin-shinsotu/img/bootstrap/icon_avatar.png" alt="logo" width="70px" height="70px"><br>
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-sm-4 control-label ppt0">流入元契約ID</label>
                                                                    <div class="col-sm-8 text">
                                                                        <span>COID00001</span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-sm-4 control-label ppt0">マイナビID</label>
                                                                    <div class="col-sm-8 text">
                                                                        <span>my20161234546</span>
                                                                    </div>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label class="col-sm-4 control-label ppt0">リクナビID</label>
                                                                    <div class="col-sm-8 text">
                                                                        <span>-</span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-sm-4 control-label ppt0">最終更新者</label>

                                                                    <div class="col-sm-8 text">
                                                                        <span class="text-navy">宮崎 範浩</span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="col-sm-4 control-label ppt0">最終更新流入元担当者ID</label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-sm-4 control-label ppt0">最終更新採用担当者ID</label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-sm-4 control-label ppt0">学生登録日時</label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-sm-4 control-label ppt0">学生更新日時</label>
                                                                ...
                                                                <div>
                                                                    <label class="col-sm-4 control-label ppt0">最終ログイン日</label>
                    ...
                    <div class="col-lg-4">
                        <div class="ibox ">
                            ...
                            <div class="ibox-content clearfix p-sm pd-bottom-none">
                                <div class="pd-none-left mrb15">
                                    <h5 class="mrt0"><a class="text-navy" href="">2016年新卒・営業</a></h5>
                                </div>
                                ...
                                <div class="bg-white custom-padding">
                                    <div class="row">
                                        <table class="table table-bordered no-margin-bottom">
                                            <tbody>
                                            <tr>
                                                <td class="col-sm-4">選考段階

                                                </td><td class="col-sm-8">2次選考</td>
                                            </tr>
                                            <tr>
                                                <td>選考ステータス
                                ...
                                <div class="pd-none-left mrb15">
                                    <h5 class="mrt0"><a class="text-navy" href="">201 6年新卒・一般</a></h5>
                                </div>
                                    ...
                                    <div class="bg-white p-sm custom-padding">
                                        <div class="row">
                                            <table class="table table-bordered sb-3 no-margin-bottom table-event">
                                                ...
                                                <tr>
                                                    <td>ファイル</td>
                                                    <td><a class="text-navy" href="">アンケート.xlsx チェックシート.jpg</a></td>
                                                </tr>
                                                <tr>
                                                    <td>評価</td>
                                                    <td>80</td>

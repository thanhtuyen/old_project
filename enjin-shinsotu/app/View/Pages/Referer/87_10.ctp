                          ...
                          <div class="">
                            <div class="tabs-container">
                              <ul class="nav nav-tabs">
                                ...
                                <li class=""><a href="87b_10">付随データ</a></li>
                              </ul>
                                      ...
                                      <form method="get" class="form-horizontal form-edit">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-8">
                                           <!--  <div class="no-borders ver-mid btn-group btn-block">
                                            ...
                                            <div class='form-control no-borders'>12345678</div>
                                          </div>
                                        </div> 
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-8">
                                            <div class="no-borders ver-mid btn-group btn-block">
                                              <select class="form-control">
                                                <option >流入元契約名</option>
                                                <option selected="selected">流入元契約名</option>
                                                <option>流入元契約名</option>
                                              </select>
                                            </div>
                                          </div>
                                        ...
                                        <div class='btn-clear'>
                                          <button type='submit' class='w-95 btn btn-primary'>クリア</button>
                                        </div>
                                      </form>
                                    </div>                                       
                                  </div>

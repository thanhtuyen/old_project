                                ...
                                <form method="get" class="form-horizontal form-edit">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-control border-none">
                                                <input type="text" value="梅原 洸太" class="form-control ">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-control border-none">
                                                <input type="text" value="kariya_neo@enjin.jp" class="form-control ">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-control border-none">
                                                <input type="text" value="090xxxxxxxx" class="form-control ">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="btn-clear">
                                            ...
                                            <button class="btn btn-primary btn-sm" id="btn-save" type="button">更新</button>
                                        </div>
                                    </div>
                                </form>
                            </div>

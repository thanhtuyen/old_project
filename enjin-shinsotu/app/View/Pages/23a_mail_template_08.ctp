                        ...
                        <div class="ibox-title">
                          ...
                          <div class="ibox-tools">
                            <div class="pull-left ibox-tools">
                              <a href="23b_mail_template_08" type="button" class="btn btn-primary btn-xs">複製</a>                                
                            </div>

                            <div class="pull-right ibox-tools">
                              <a href="23c_mail_template_08" type="button" class="btn btn-primary btn-xs">編集</a>                                
                            </div>
                          </div>
                        </div>
                          ...
                          <div class=''>
                            <div class="table-border">
                              <table class="table table-bordered no-margin-bottom">
                                ...
                                <tr>
                                  <td colspan="2">
                                    <span class="text-navy">候補者名</span>様<br />

                                    <p>弊社をより深くご理解いただくために、会社説明会を開催いたします。</p>
                                    <p>当日は、会社概要説明および若手社員との座談会により当社の雰囲気を感じて
                                      いただければと思っています。 会社説明会ご参加後に、応募可否をご判断いた
                                      だいて構いませんので、当社にご興味をお持ちの方は、是非お気軽にご参加下
                                      さい。</p>
                                      <p>対象職種： 事務系・技術系</p>
                                      <p>日程： ５月２０日（水）１０時～・１４時～ （２回開催）</p>
                                      <p>場所： <span class="text-navy">会社名</span></p>
                                      <p>住所： 港区赤坂住所1−23−64 ビル4階 第2会議室</p>
                                      <p>担当： 採用担当 <span class="text-navy">送信者名</span></p>
                                    </td>
                                  </tr>
                                </table>
                              </div>

                    ...
                    <div class="col-lg-8">
                      <div class="tabs-container ibox">
                        <ul class="nav nav-tabs">
                          <li class=""><a href="10b_event_management_06">登録してください</a></li>
                          <li class="active"><a data-toggle="tab" href="#tab-1" aria-expanded="false">+</a></li>
                        </ul>
                              ...
                              <div class="ibox-content" style="display: block;">
                                <form method="get" class="form-horizontal form-edit">
                                  ...
                                  <div class="form-group"><label class="col-sm-4 control-label">当日内容</label>
                                    <div class="col-sm-8">
                                      <textarea class='form-control' rows='6'>当日内容入力</textarea>
                                    </div>
                                  </div>

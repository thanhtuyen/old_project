                                 ...
                                 <div class="col-lg-3 m-t-lg">
                                  ...
                                  <div class="col-lg-9">
                                    <form method="get" class="form-horizontal">
                                      	<div class="form-group"><label class="col-sm-4 control-label">採用担当者ID </label>
		                                  <div class="col-sm-8">
		                                    <div class="form-control border-none">st0003</div>
		                                  </div>
		                                </div>
		                                <div class = "clear10"></div>
		                                <div class="form-group"><label class="col-sm-4 control-label">氏</label>
			                                <div class="col-sm-8"><input type="text" class="form-control" value="一ノ瀬"></div>
			                            </div>
			                            <div class = "clear10"></div>
			                           	<div class="form-group"><label class="col-sm-4 control-label">名</label>
			                                <div class="col-sm-8"><input type="text" class="form-control" value="裕太郎"></div>
			                            </div>
			                            <div class = "clear10"></div>
			                            ...
			                            <div class="form-group"><label class="col-sm-4 control-label">電話</label>
			                                <div class="col-sm-8"><input type="text" class="form-control" value="090xxxxxxxx"></div>
			                            </div>
			                            <div class = "clear10"></div>

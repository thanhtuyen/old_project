                          ...
                          <div class="">
                            <div class="table-border">
                              <table class="table table-bordered no-margin-bottom">
                                ...
                                <tr>
                                  <th>用途</th>
                                  <td><input class="form-control" type="text" value="イベントAのコピー"></td>
                                </tr>
                                <tr>
                                  <th>用途</th>
                                  <td>
                          ...
                          <div class=''>
                            <div class="table-border">
                              <table class="table table-bordered no-margin-bottom">
                                <tr>
                                  <th>タイトル</th>
                                  <td><input class="form-control" type="text" value="イベントのおしらせ"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td colspan="2">
                                    <span class="text-navy">候補者名</span><br />

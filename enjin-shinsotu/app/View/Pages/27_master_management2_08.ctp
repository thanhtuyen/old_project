                ...
                <div class="margin-top-15 col-lg-6">
                  ...
                  <div class="ibox-content clearfix p-sm">
                          <div class="">
                            <div class="table-border">
                              <table class="table table-bordered no-margin-bottom">
                                ...
                                <tbody>
                                  <tr>
                                    <td class="">AREA001</td>
                                    <td class="text-left">東京</td>
                                    <td><button class="full-width btn btn-primary btn-sm">削除</button></td>
                                  </tr>
                                  <tr>                 
                                    <td class="">AREA002</td>
                                    <td class="text-left">名古屋</td>
                                    <td><button class="full-width btn btn-primary btn-sm">削除</button></td>
                                  </tr>
                                  <tr>
                                    <td></td>
                                    <td class=""><input class="form-control height_control" type="text" value="エリア名入力"></td>
                                    <td class=""><button class="full-width btn btn-primary btn-sm">追加</button></td>
                                  </tr>      
                            ...
                            <p class = "text-center">
                            <a  class = "margin20 text-center" ref="#">キャンセル</a>

                          ...
                          <li>
                            <div class="dropdown-messages-box">
                              <a href="profile.html" class="pull-left">
                                <?php echo $this->Html->image("bootstrap/a7.jpg", array("class" => "img-circle",)); ?>
                              </a>
                      ...
                      <div class="ibox">
                        <div class="ibox-title">
                          ...
                          <div class="ibox-tools">
                            <a href="29b_09" type="button" class="btn btn-primary btn-xs">編集</a>
                          </div>
                        </div>
                          ...
                          <div class="col-lg-9">
                            <form method="get" class="form-horizontal">
                              ...
                              <div class="form-group">
                                <label class="col-sm-5 control-label">採用担当者ID</label>
                                <div class="col-sm-7">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                  <div class="form-control border-none">一ノ瀬 裕太郎</div>
                                </div>
                              </div>

                              <div class="form-group">
                                <label class="col-sm-5 control-label">メール</label>
                                <div class="col-sm-7">
                                  <div class="form-control border-none">
                                    <a class='text-navy' href="">umehara＠enjin.jp</a>
                                  </div>
                                </div>
                              </div>

                              <div class="form-group">
                                <label class="col-sm-5 control-label">電話</label>
                                <div class="col-sm-7">
                                  <div class="form-control border-none">090xxxxxxxx</div>
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="col-sm-5 control-label">ステータス</label>
                                <div class="col-sm-7">
                              ...
                              <div class="form-group">
                                <label class="col-sm-5 control-label">最終更新採用担当者</label>
                                <div class="col-sm-7">
                                  <div class="form-control border-none">
                              ...
                              <div class="form-group">
                                <label class="col-sm-5 control-label">最終ログイン日</label>
                                <div class="col-sm-7">

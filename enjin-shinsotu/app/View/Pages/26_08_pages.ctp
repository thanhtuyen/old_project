...
<head>
  ...
  <?php echo $this->Html->css('enjin/page26_08'); ?>
        ...
        <div class="row">
          <div class="col-lg-8">
           <div class="ibox">
                    ...
                    <tr>
                      <th class="col-sm-2 text-center">順番</th>
                      <th class="col-sm-3 text-center">選考段階名</th>
                      <th class="col-sm-4 text-center">選考概要</th>
                      <th class="col-sm-2 text-center">有効フラグ</th>
                    </tr>
                    <tr>
                      <td >1</td>
                      <td><input type="text" placeholder="書 類選 考"></td>
                      <td><input type="text" placeholder="選 考 概 要 テ キ ス ト"></td>
                      <td><input type="checkbox" class="js-switch" checked="" data-switchery="true"></td>
                    </tr>
                    <tr>
                      <td >2</td>
                      <td ><input type="text" placeholder="1 次選考"></td>
                      <td><input type="text" placeholder="選 考 概 要 テ キ ス ト"></td>
                      <td><input type="checkbox" class="js-switch_2" checked="" data-switchery="true"></td>
                      </tr>
                    <tr>
                      <td>3</td>
                      <td><input type="text" placeholder="2 次選考"></td>
                      <td><input type="text" placeholder="選 考 概 要 テ キ ス ト"></td>
                      <td><input type="checkbox" class="js-switch_3" checked="" data-switchery="true"></td>
                    </tr>
                    <tr >
                      <td >4</td> 
                      <td><input type="text" placeholder="3 次選考"></td>
                     
                      <td><input type="text" placeholder="選 考 概 要 テ キ ス ト"></td>
                      <td><input type="checkbox" class="js-switch_4" checked="" data-switchery="true"></td>
                    </tr>
                    <tr >
                      <td >5</td> 
                      ...
                      <td><input type="text" placeholder=""></td>
                      <td><input type="checkbox" class="js-switch_5" checked="" data-switchery="true"></td>
                    </tr>
                    <tr >
                      <td >6</td> 
                      <td><input type="text" placeholder=""></td>
                      <td><input type="text" placeholder=""></td>
                      <td><input type="checkbox" class="js-switch_6" checked="" data-switchery="true"></td>
                    </tr>
                    <tr >
                      <td >7</td> 
                      <td><input type="text" placeholder=""></td>
                      <td><input type="text" placeholder=""></td>
                      <td><input type="checkbox" class="js-switch_7" checked="" data-switchery="true"></td>
                    </tr>
                    <tr >
                      <td >8</td> 
                      <td><input type="text" placeholder=""></td>
                      <td><input type="text" placeholder=""></td>
                      <td><input type="checkbox" class="js-switch_8" checked="" data-switchery="true"></td>
                    </tr>
                    <tr>
                      <td >9</td> 
                      <td><input type="text" placeholder=""></td>
                      <td><input type="text" placeholder=""></td>
                      <td><input type="checkbox" class="js-switch_9" checked="" data-switchery="true"></td>
                    </tr>
                    <tr>
                      <td class="text-center p-t-xs" >最 終</td>
                       <td><input type="text" placeholder="最 終選 考"></td>
                      <td><input type="text" placeholder="選 考 概 要 テ キ ス ト"></td>
                      <td><input type="checkbox" class="js-switch_10" checked="" data-switchery="true"></td>
                    </tr>
                  </table>
                                  </div>
                                </div>

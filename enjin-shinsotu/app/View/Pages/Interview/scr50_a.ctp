                    ...
                    <div class="ibox">
                            ...
                            <div class="col-lg-9">
                                <form method="get" class="form-horizontal form-edit">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input class="form-control " type="text" value="梅原">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input class="form-control " type="text" value="加里矢">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input class="form-control " type="text" value="kariya_neo@enjin.jp">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input class="form-control" type="text" value="090xxxxxxxx">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="ibox-content bg-white p-sm clearfix fr-child fr-hiden">
                            <div class="col-lg-12 form-edit">
                                ...
                                <div class="btn-clear">
                                    <a class="text-navy" href="#">キャンセル</a>
                                    <button class="btn btn-primary btn-sm" id="btn-sub-save" type="button">変更</button>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
        $("#show-fr-child").click(function(){
            $('.fr-child').toggleClass("fr-hiden")
            $('.show-fr-input').toggleClass("fr-hiden")
        });

        $("#btn-sub-save").click(function(){
            $('.fr-child').toggleClass("fr-hiden")
            $('.show-fr-input').toggleClass("fr-hiden")
        });
    });

                                  ...
                                  <div class="col-lg-9">
                                    <form method="get" class="form-horizontal">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                          <div class="form-control border-none">梅原 洸太</div>
                                        </div>
                                      </div>
                                      <div class="form-group">
                                        <label class="col-sm-4 control-label">部署</label>
                                        <div class="col-sm-8">
                                          <div class="form-control border-none">営業部</div>
                                        </div>
                                      </div>
                                      <div class="form-group">
                                        <label class="col-sm-4 control-label">採用者タイプ</label>
                                        <div class="col-sm-8">
                                          <div class="form-control border-none">採用部</div>
                                        </div>
                                      </div>
                                      <div class="form-group">
                                        <label class="col-sm-4 control-label">メール</label>
                                        <div class="col-sm-8">
                                          <div class="form-control border-none">umehara＠enjin.jp</div>
                                        </div>
                                      </div>
                                      <div class="form-group">
                                  ...
                                  <div class='col-lg-9'>
                                    <form method="get" class="form-horizontal">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                          <div class="">
                                            <input class='form-control border-none' type='text' value='洸太'>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                          <div class="">
                                            <div class="no-borders ver-mid btn-group btn-block m-b-xs">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                          <div class="">
                                            <input class='form-control border-none' type='text' value='umehara＠enjin.jp'>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="form-group">
                            ...
                            <div class="col-lg-7 fr-hiden">
                              ...
                              <div class="">
                                ...
                                <div class="content-s col-lg-12">
                                  ...
                                  <div class="tb-footer">
                                    <a href="#">キャンセル</a>
                                    <button class="btn btn-white" id="btn-child-save" type="button">変更</button>
                                  </div>
                                </div>
                              </div>
                            </div>

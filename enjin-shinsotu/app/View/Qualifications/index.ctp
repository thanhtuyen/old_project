<div class="qualifications index">
	...
	<tr>
		...
		<td><?php echo h($qualification['Qualification']['name']); ?>&nbsp;</td>
		<td><?php echo h($qualification['Qualification']['status']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $qualification['Qualification']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $qualification['Qualification']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
